...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		["Flan The Man", 		"", 							"Dialogue sprites, playable Nate stuff",						"https://twitter.com/F14nTh3M4n"], // NO ICON YET
		["JoeyAnimations",	"joey", 					"Nate Alt Animations",															"https://twitter.com/joey_animations", 0xFF8797d8],
		//["Code"],
		...
		["satellaviewlive", "stella", 				"Modchart",																					"https://www.youtube.com/channel/UCCdIBcUR5ZK7SLS42Da-3fQ", 0xFFFF7D07],
		//["Chart"],
